const contractAddress = "0xf6E9b53D9e607aCA44dAdF62e4ac89566b38449a"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to Camel Jockey Club";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The main goals of Camel Jockey Club are to increase the value of its NFTs for the owners and to make our world a better place to live for all. Join the club and lets do it together. <br> To learn more, please join our Discord community:  <a href="https://discord.gg/hRrN99BHRt"  target="_blank" rel="noopener noreferrer">Camel Jockey Club</a>';
...
const p_presale_coming_soon = "The Whitelist is now closed.  Thank you so very much for participating.  Please follow us on twitter to find out who are the winners of the 10 Free NFT draws, starting in the first week of May.";
...
const button_presale_coming_soon = "Whitelist is Now Closed.";
const button_presale_mint_whitelisted = "Mint Your Special NFT";
const button_presale_mint_not_whitelisted = "Join the Discord Community";
